...
/**
 * Created by sreer on 08-04-2017.
 */
...
public class UsersChatAdapter extends RecyclerView.Adapter<UsersChatAdapter.ViewHolderUsers> {
    ...
    public void onBindViewHolder(ViewHolderUsers holder, int position) {
        ...
        if(fireChatUser.getConnection().equals(ONLINE)) {
            // Green color
            holder.getStatusConnection().setTextColor(Color.parseColor("#008000"));
        }else {
            // Red color
    ...
    public class ViewHolderUsers extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            chatIntent.putExtra(ExtraIntent.EXTRA_RECIPIENT_NAME,user.getDisplayName());
            //Start new activity
            mContextViewHolder.startActivity(chatIntent);
//            Bundle bundle = new Bundle();
//            bundle.putString(ExtraIntent.EXTRA_CURRENT_USER_ID,mCurrentUserId);
//            bundle.putString(ExtraIntent.EXTRA_RECIPIENT_ID,user.getRecipientId());
//            bundle.putString(ExtraIntent.EXTRA_CHAT_REF,chatRef);
//
//
//            FragmentManager fragments = ((ChatLoaderActivity) mContext).getSupportFragmentManager();
//            FragmentTransaction fragmentTransaction = fragments.beginTransaction();
//            ChatFragment chatter = new ChatFragment();
//            chatter.setArguments(bundle);
//            android.app.Fragment fragment = ((AppCompatActivity) mContext).getFragmentManager().findFragmentById(R.id.fragment_chat);
//            //filterFragment = new FilterFragment();
//            fragmentTransaction.replace(R.id.fragment_chat, chatter);
